...
from model import AttentionUNet, AttentionUNetResNet18
...
def get_args():
    ...
    parser.add_argument('--seed', type=int, default=1, help='Random seed (1 ~ 100)')
...
## 세팅!
save_root = './results/attention_unet_fuzzy_pt'
num_epochs = 50
args = get_args()
fold_idx = args.fold
seed = args.seed
save_root = f'./results/attention_unet_pt_{seed}'
